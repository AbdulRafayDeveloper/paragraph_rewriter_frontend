                    ...
                    FeaturedCardData.map((el,idx)=>(
                        <div key={idx} className=" p-6 bg-slate-100 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                ...
                                <span className="mb-2 text-xl tracking-tight text-gray-900 dark:text-white">{el.title}</span>
                                </span>
                            </a>
                            <p className="mb-3 mt-4 text-lg font-normal text-gray-700 dark:text-gray-400"> {el.content}</p>
                        </div>
                    ))
                }
            </div>
